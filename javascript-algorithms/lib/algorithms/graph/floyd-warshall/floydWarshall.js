...
function floydWarshall(graph) {
  ...
  var nextVertices = Array(vertices.length).fill(null).map(function () {
  ...
  var distances = Array(vertices.length).fill(null).map(function () {
  ...
  vertices.forEach(function (startVertex, startIndex) {
    vertices.forEach(function (endVertex, endIndex) {
      if (startVertex === endVertex) {
        ...
        var edge = graph.findEdge(startVertex, endVertex);
  ...
  vertices.forEach(function (middleVertex, middleIndex) {
    ...
    vertices.forEach(function (startVertex, startIndex) {
      ...
      vertices.forEach(function (endVertex, endIndex) {
        ...
        var distViaMiddle = distances[startIndex][middleIndex] + distances[middleIndex][endIndex];
