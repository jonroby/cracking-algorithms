...
var _dijkstra3 = require('../dijkstra');

var _dijkstra4 = _interopRequireDefault(_dijkstra3);
...
describe('dijkstra', function () {
  it('should find minimum paths to all vertices for undirected graph', function () {
    ...
    var _dijkstra = (0, _dijkstra4.default)(graph, vertexA),
  ...
  it('should find minimum paths to all vertices for directed graph with negative edge weights', function () {
    ...
    var _dijkstra2 = (0, _dijkstra4.default)(graph, vertexS),
