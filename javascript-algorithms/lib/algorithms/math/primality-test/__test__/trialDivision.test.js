...
var _trialDivision = require('../trialDivision');

var _trialDivision2 = _interopRequireDefault(_trialDivision);
...
describe('trialDivision', function () {
  it('should detect prime numbers', function () {
    primalityTest(_trialDivision2.default);
  });
});