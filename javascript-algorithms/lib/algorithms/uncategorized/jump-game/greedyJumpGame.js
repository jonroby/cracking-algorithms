...
exports.default = greedyJumpGame;
/**
...
function greedyJumpGame(numbers) {
  ...
  var leftGoodPosition = numbers.length - 1;

  // Go through all numbers from right to left.
  for (var numberIndex = numbers.length - 2; numberIndex >= 0; numberIndex -= 1) {
    ...
    // from it.
    var maxCurrentJumpLength = numberIndex + numbers[numberIndex];
