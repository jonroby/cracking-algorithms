...
exports.default = nQueensBitwise;
/**
...
function nQueensBitwiseRecursive(boardSize) {
  var leftDiagonal = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  var column = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
  var rightDiagonal = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
  var solutionsCount = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;

  // Keeps track of the number of valid solutions.
  var currentSolutionsCount = solutionsCount;
  ...
  // bits beyond the Nth.
  var isDone = Math.pow(2, boardSize) - 1;
  ...
  // queen there.
  var availablePositions = ~(leftDiagonal | rightDiagonal | column);
  ...
  while (availablePositions & isDone) {
    ...
    var firstAvailablePosition = availablePositions & -availablePositions;
     ...
     * is 1010.
     */
    currentSolutionsCount += nQueensBitwiseRecursive(boardSize, (leftDiagonal | firstAvailablePosition) >> 1, column | firstAvailablePosition, (rightDiagonal | firstAvailablePosition) << 1, solutionsCount);
  }
