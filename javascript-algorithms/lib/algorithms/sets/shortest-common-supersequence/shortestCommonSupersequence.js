...
exports.default = shortestCommonSupersequence;

var _longestCommonSubsequence = require('../longest-common-subsequence/longestCommonSubsequence');
...
function shortestCommonSupersequence(set1, set2) {
  ...
  var lcs = (0, _longestCommonSubsequence2.default)(set1, set2);
  ...
  var setIndex2 = 0;
  var lcsIndex = 0;
  var setOnHold1 = false;
  var setOnHold2 = false;
