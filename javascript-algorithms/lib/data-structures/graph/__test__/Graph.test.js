...
describe('Graph', function () {
  ...
  it('should generate adjacency matrix for undirected graph', function () {
    ...
    expect(adjacencyMatrix).toEqual([[Infinity, 0, Infinity, Infinity], [0, Infinity, 0, 0], [Infinity, 0, Infinity, 0], [Infinity, 0, 0, Infinity]]);
  });
  ...
  it('should generate adjacency matrix for directed graph', function () {
    ...
    var adjacencyMatrix = graph.getAdjacencyMatrix();
    expect(adjacencyMatrix).toEqual([[Infinity, 2, Infinity, Infinity], [Infinity, Infinity, 1, 7], [Infinity, Infinity, Infinity, 5], [Infinity, Infinity, Infinity, Infinity]]);
  });
});